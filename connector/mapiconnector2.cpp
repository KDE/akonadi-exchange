...
bool MapiObject::propertiesPull(SPropTagArray *tags)
{
	error() << "pulling" << tags->cValues;
	if (MAPI_E_SUCCESS != GetProps(&m_object, MAPI_UNICODE, tags, &m_properties, &m_propertyCount)) {
